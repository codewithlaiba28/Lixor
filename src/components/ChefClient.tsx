      ...
      <section className="relative pt-32 pb-12 px-6">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center z-10 relative">
          <motion.span 
            ...
            className="text-[#FF5C00] font-sans font-semibold text-[11px] tracking-[0.25em] uppercase mb-4"
          >
            MEET THE EXPERTS
          </motion.span>
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-[52px] font-serif font-medium text-[#1A1A1A] leading-[1.1] tracking-tight mb-6"
          >
          ...
          <motion.p 
            ...
            className="text-[#666666] text-base md:text-[18px] max-w-xl mx-auto font-sans leading-relaxed mb-10"
          >
            Come experience a world of rich flavors, cozy ambiance, and dishes crafted with love. From sizzling grills to delicate pastries.
          </motion.p>
      ...
      <section className="pb-24 px-6">
        <div className="max-w-[1200px] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            className="rounded-[24px] md:rounded-[40px] overflow-hidden shadow-2xl shadow-black/10"
          >
            <img 
