...
const galleryItems = [
  { image: "/images/pages/gallery/image1.avif", title: "Clean & hygienic kitchen view", rotate: -3 },
  { image: "/images/pages/gallery/image2.avif", title: "Always serve with love", rotate: 2 },
  { image: "/images/pages/gallery/image3.avif", title: "Famous visit to restaurant", rotate: -2 }
];
    ...
    <main className="bg-white overflow-hidden relative min-h-screen">
      ...
      <section className="relative pt-32 pb-12 px-6">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center z-10 relative">
          ...
          <h1 className="text-4xl md:text-[56px] font-serif font-medium text-[#1A1A1A] leading-[1.05] tracking-tight mb-6">
            Discover the beauty<br />of our food creations
          </h1>

          <p className="text-[#666666] text-base md:text-[18px] max-w-xl mx-auto font-sans leading-relaxed">
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {galleryItems.map((item, i) => (
            <motion.div
              ...
              animate={{ rotate: isMobile ? 0 : item.rotate }}
            >
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((n, i) => (
              ...
              >
                <img 
                  src={`/images/pages/gallery/moments/image${n}.${n === 4 || n === 6 ? 'webp' : 'avif'}`} 
                  alt={`Moment ${n}`} 
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                />
              </motion.div>
