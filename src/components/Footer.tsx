  ...
  return (
    <footer className="bg-white pt-24 pb-6 px-6 border-t border-black/5">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-3">
              {[
                ...
                <Link key={social.name} href="#" className="w-8 h-8 rounded-full border border-black/5 flex items-center justify-center hover:bg-black hover:text-white transition-all">
      ...
      <div className="max-w-[1200px] mx-auto mt-12 pt-0 flex flex-col md:flex-row justify-between items-center gap-6 text-[#999] text-[13px] font-sans">
        ...
        <div className="bg-white border border-black/10 px-4 py-2 rounded-xl flex items-center gap-2 shadow-sm">
          ...
          <span className="font-bold text-[#1A1A1A]">Made in Framer</span>
        </div>
      </div>
    </footer>
  );
