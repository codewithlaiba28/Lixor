                ...
                <div className="absolute top-[10%] right-[12%] w-10 h-10 bg-[#FF5C00] rounded-full text-white shadow-xl shadow-orange-500/30 transform translate-x-1/2 -translate-y-1/2 z-20 overflow-hidden">
                  <div className="relative w-full h-full">
                    <div className="absolute inset-0 flex items-center justify-center transition-transform duration-500 ease-[cubic-bezier(0.87,0,0.13,1)] group-hover:-translate-y-full">
                      <img src="/images/menu-categories/logo/main-course.svg" alt="Main Course category icon" className="w-[18px] h-[18px]" />
                    </div>
            ...
            <Link href="/menu" className="flex flex-col items-center gap-6 md:-translate-y-12 group cursor-pointer">
              <div className="relative w-[170px] perspective-1000">
                ...
                <div className="absolute top-[10%] right-[12%] w-10 h-10 bg-[#FF5C00] rounded-full text-white shadow-xl shadow-orange-500/30 transform translate-x-1/2 -translate-y-1/2 z-20 overflow-hidden">
                  <div className="relative w-full h-full">
                    <div className="absolute inset-0 flex items-center justify-center transition-transform duration-500 ease-[cubic-bezier(0.87,0,0.13,1)] group-hover:-translate-y-full">
                      <img src="/images/menu-categories/logo/desserts.svg" alt="Desserts category icon" className="w-[18px] h-[18px]" />
                    </div>
                    <div className="absolute inset-0 flex items-center justify-center translate-y-full transition-transform duration-500 ease-[cubic-bezier(0.87,0,0.13,1)] group-hover:translate-y-0">
                      <img src="/images/menu-categories/logo/desserts.svg" alt="Desserts category icon" className="w-[18px] h-[18px]" />
                    </div>
            ...
            <Link href="/menu" className="flex flex-col items-center gap-6 group cursor-pointer">
              <div className="relative w-[170px] perspective-1000">
                ...
                <div className="absolute top-[10%] right-[12%] w-10 h-10 bg-[#FF5C00] rounded-full text-white shadow-xl shadow-orange-500/30 transform translate-x-1/2 -translate-y-1/2 z-20 overflow-hidden">
                  <div className="relative w-full h-full">
                    <div className="absolute inset-0 flex items-center justify-center transition-transform duration-500 ease-[cubic-bezier(0.87,0,0.13,1)] group-hover:-translate-y-full">
                      <img src="/images/menu-categories/logo/appetizer.svg" alt="Appetizer category icon" className="w-[18px] h-[18px]" />
                    </div>
                    <div className="absolute inset-0 flex items-center justify-center translate-y-full transition-transform duration-500 ease-[cubic-bezier(0.87,0,0.13,1)] group-hover:translate-y-0">
                      <img src="/images/menu-categories/logo/appetizer.svg" alt="Appetizer category icon" className="w-[18px] h-[18px]" />
                    </div>
            ...
            <Link href="/menu" className="flex flex-col items-center gap-6 md:-translate-y-12 group cursor-pointer">
              <div className="relative w-[170px] perspective-1000">
                ...
                <div className="absolute top-[10%] right-[12%] w-10 h-10 bg-[#FF5C00] rounded-full text-white shadow-xl shadow-orange-500/30 transform translate-x-1/2 -translate-y-1/2 z-20 overflow-hidden">
                  <div className="relative w-full h-full">
                    <div className="absolute inset-0 flex items-center justify-center transition-transform duration-500 ease-[cubic-bezier(0.87,0,0.13,1)] group-hover:-translate-y-full">
                      <img src="/images/menu-categories/logo/starte.svg" alt="Starter category icon" className="w-[18px] h-[18px]" />
                    </div>
                    <div className="absolute inset-0 flex items-center justify-center translate-y-full transition-transform duration-500 ease-[cubic-bezier(0.87,0,0.13,1)] group-hover:translate-y-0">
                      <img src="/images/menu-categories/logo/starte.svg" alt="Starter category icon" className="w-[18px] h-[18px]" />
                    </div>
      ...
      <section className="relative px-6 max-w-[1200px] mx-auto mt-16 md:mt-24 pb-12 z-10 flex flex-col md:flex-row items-center gap-12 md:gap-20">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start">
          <div className="flex items-center gap-2 mb-6">
            <img src="/images/about/best-dining-experience.avif" alt="Dining experience decoration" className="w-6 h-4 object-contain opacity-80 shrink-0" />
            <span className="text-[#1A1A1A] font-medium text-[15px]">Best Dining Experience</span>
            <img src="/images/about/best-dining-experience1.avif" alt="Dining experience decoration" className="w-6 h-4 object-contain opacity-80 shrink-0" />
          </div>
          ...
          <div className="w-full lg:w-[65%] grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-16">
            ...
            <div className="flex items-start gap-6">
              <div className="w-14 h-14 rounded-full bg-[#FFF5F0] flex items-center justify-center shrink-0">
                <img src="/images/Why Choose Us Section/logo1.svg" alt="Fresh ingredients icon" className="w-7 h-7" />
              </div>
              <div>
            ...
            <div className="flex items-start gap-6">
              <div className="w-14 h-14 rounded-full bg-[#FFF5F0] flex items-center justify-center shrink-0">
                <img src="/images/Why Choose Us Section/logo2.svg" alt="Creative plating icon" className="w-7 h-7" />
              </div>
              <div>
            ...
            <div className="flex items-start gap-6">
              <div className="w-14 h-14 rounded-full bg-[#FFF5F0] flex items-center justify-center shrink-0">
                <img src="/images/Why Choose Us Section/logo3.svg" alt="Artisan recipes icon" className="w-7 h-7" />
              </div>
              <div>
            ...
            <div className="flex items-start gap-6">
              <div className="w-14 h-14 rounded-full bg-[#FFF5F0] flex items-center justify-center shrink-0">
                <img src="/images/Why Choose Us Section/logo4.svg" alt="Locally sourced icon" className="w-7 h-7" />
              </div>
              <div>
            ...
            <div className="flex items-start gap-6">
              <div className="w-14 h-14 rounded-full bg-[#FFF5F0] flex items-center justify-center shrink-0">
                <img src="/images/Why Choose Us Section/logo5.svg" alt="Sustainable practices icon" className="w-7 h-7" />
              </div>
              <div>
            ...
            <div className="flex items-start gap-6">
              <div className="w-14 h-14 rounded-full bg-[#FFF5F0] flex items-center justify-center shrink-0">
                <img src="/images/Why Choose Us Section/logo6.svg" alt="Exceptional service icon" className="w-7 h-7" />
              </div>
              <div>
