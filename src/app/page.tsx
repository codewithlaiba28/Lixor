    ...
    <main className="bg-white overflow-hidden relative min-h-screen">
      ...
      <section className="relative px-6 max-w-[1200px] mx-auto mt-28 pb-8 z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-0">
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group w-[170px]">
              <div className="w-full aspect-[2/3] bg-neutral-100 rounded-[999px] overflow-hidden shadow-sm relative">
                <img src="/images/menu-categories/main-course.avif" alt="Main Course" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
              </div>
          ...
          <div className="flex flex-col items-center gap-6 md:-translate-y-12">
            <div className="relative group w-[170px]">
              <div className="w-full aspect-[2/3] bg-neutral-100 rounded-[999px] overflow-hidden shadow-sm relative">
                <img src="/images/menu-categories/dessert.avif" alt="Desserts" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
              </div>
              <div className="absolute top-[10%] right-[12%] w-10 h-10 bg-[#FF5C00] rounded-full text-white shadow-xl shadow-orange-500/30 transform translate-x-1/2 -translate-y-1/2 z-20 overflow-hidden">
                <div className="relative w-full h-full">
                  <div className="absolute inset-0 flex items-center justify-center transition-transform duration-0 group-hover:duration-500 ease-[cubic-bezier(0.87,0,0.13,1)] group-hover:-translate-y-full">
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group w-[170px]">
              <div className="w-full aspect-[2/3] bg-neutral-100 rounded-[999px] overflow-hidden shadow-sm relative">
                <img src="/images/menu-categories/appetizer.avif" alt="Appetizer" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
              </div>
              <div className="absolute top-[10%] right-[12%] w-10 h-10 bg-[#FF5C00] rounded-full text-white shadow-xl shadow-orange-500/30 transform translate-x-1/2 -translate-y-1/2 z-20 overflow-hidden">
                <div className="relative w-full h-full">
                  <div className="absolute inset-0 flex items-center justify-center transition-transform duration-0 group-hover:duration-500 ease-[cubic-bezier(0.87,0,0.13,1)] group-hover:-translate-y-full">
          ...
          <div className="flex flex-col items-center gap-6 md:-translate-y-12">
            <div className="relative group w-[170px]">
              <div className="w-full aspect-[2/3] bg-neutral-100 rounded-[999px] overflow-hidden shadow-sm relative">
                <img src="/images/menu-categories/starter.avif" alt="Starter" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
              </div>
              <div className="absolute top-[10%] right-[12%] w-10 h-10 bg-[#FF5C00] rounded-full text-white shadow-xl shadow-orange-500/30 transform translate-x-1/2 -translate-y-1/2 z-20 overflow-hidden">
                <div className="relative w-full h-full">
                  <div className="absolute inset-0 flex items-center justify-center transition-transform duration-0 group-hover:duration-500 ease-[cubic-bezier(0.87,0,0.13,1)] group-hover:-translate-y-full">
      ...
      <section className="py-12 px-6 bg-white flex flex-col items-center text-center">
        ...
        <div className="w-full max-w-[1200px] mx-auto flex flex-wrap md:flex-nowrap items-center justify-center gap-5 px-4">
          ...
          >
            <img src="/images/Gallery CTA Section/image1.avif" alt="" className="w-full h-full object-cover transition-transform duration-700 group-hover/img:scale-110" />
          </motion.div>
          ...
          >
            <img src="/images/Gallery CTA Section/image2.avif" alt="" className="w-full h-full object-cover transition-transform duration-700 group-hover/img:scale-110" />
          </motion.div>
          ...
          >
            <img src="/images/Gallery CTA Section/image3.avif" alt="" className="w-full h-full object-cover transition-transform duration-700 group-hover/img:scale-110" />
          </motion.div>
          ...
          >
            <img src="/images/Gallery CTA Section/image4.avif" alt="" className="w-full h-full object-cover transition-transform duration-700 group-hover/img:scale-110" />
          </motion.div>
        </div>
      </section>
